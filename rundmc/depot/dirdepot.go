...
func (d *DirectoryDepot) toPeaProcessDir(sandboxHandle, handle string) string {
	return filepath.Join(d.dir, sandboxHandle, "processes", handle, "processes", handle+"-PEA-PROCESS")
}
