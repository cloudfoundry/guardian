...
func (fake *FakeVolumeCreator) Create(log lager.Logger, spec garden.ContainerSpec) (specs.Spec, error) {
...
func (fake *FakeVolumeCreator) CreateArgsForCall(i int) (lager.Logger, garden.ContainerSpec) {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
...
var _ peas.VolumeCreator = new(FakeVolumeCreator)
