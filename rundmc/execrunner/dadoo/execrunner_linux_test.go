...
var _ = Describe("Dadoo ExecRunner", func() {
	...
	BeforeEach(func() {
		...
		runner = dadoo.NewExecRunner("path-to-dadoo", "path-to-runc", "runc-root",
			signallerFactory, fakeCommandRunner, false, 5, 6, bundleSaver, processDepot)
...
{"time":"2016-03-02T13:56:38Z", "level":"fatal", "msg":"Container start failed: [10] System error: fork/exec POTATO: no such file or directory"}`
	...
	Describe("Run", func() {
		...
		Context("when cleanupProcessDirsOnWait is true", func() {
			BeforeEach(func() {
				runner = dadoo.NewExecRunner("path-to-dadoo", "path-to-runc", "runc-root",
					signallerFactory, fakeCommandRunner, true, 5, 6, bundleSaver, processDepot)
			})
	...
	// TODO: RunPea now runs a regular process, the nly difference is that uses another directoy//
	// TODO :Implement
	...
	Describe("Attach after Run", func() {
		Context("when cleanupProcessDirsOnWait is true", func() {
			BeforeEach(func() {
				runner = dadoo.NewExecRunner("path-to-dadoo", "path-to-runc", "runc-root", signallerFactory, fakeCommandRunner, true, 5, 6, bundleSaver, processDepot)
			})
		...
		Context("when cleanupProcessDirsOnWait is false", func() {
			BeforeEach(func() {
				runner = dadoo.NewExecRunner("path-to-dadoo", "path-to-runc", "runc-root", signallerFactory, fakeCommandRunner, false, 5, 6, bundleSaver, processDepot)
			})
