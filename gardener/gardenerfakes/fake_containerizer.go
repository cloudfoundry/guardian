...
func (fake *FakeContainerizer) UpdateLimits(log lager.Logger, handle string, limits garden.Limits) error {
...
func (fake *FakeContainerizer) UpdateLimitsReturnsOnCall(i int, result1 error) {
	fake.UpdateLimitsStub = nil
