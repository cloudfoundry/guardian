...
func (fake *FakeNetworker) SetupBindMountsForPea(arg1 lager.Logger, arg2 string, arg3 string, arg4 bool, arg5 string) ([]garden.BindMount, error) {
...
func (fake *FakeNetworker) SetupBindMountsForPeaCallCount() int {
...
func (fake *FakeNetworker) SetupBindMountsForPeaCalls(stub func(lager.Logger, string, string, bool, string) ([]garden.BindMount, error)) {
	fake.setupBindMountsForPeaMutex.Lock()
	defer fake.setupBindMountsForPeaMutex.Unlock()
	fake.SetupBindMountsForPeaStub = stub
}

func (fake *FakeNetworker) SetupBindMountsForPeaArgsForCall(i int) (lager.Logger, string, string, bool, string) {
	fake.setupBindMountsForPeaMutex.RLock()
	defer fake.setupBindMountsForPeaMutex.RUnlock()
...
func (fake *FakeNetworker) SetupBindMountsForPeaReturns(result1 []garden.BindMount, result2 error) {
	fake.setupBindMountsForPeaMutex.Lock()
	defer fake.setupBindMountsForPeaMutex.Unlock()
...
func (fake *FakeNetworker) SetupBindMountsForPeaReturnsOnCall(i int, result1 []garden.BindMount, result2 error) {
	fake.setupBindMountsForPeaMutex.Lock()
	defer fake.setupBindMountsForPeaMutex.Unlock()
	fake.SetupBindMountsForPeaStub = nil
