...
func (fake *FakeImage) Reference() types.ImageReference {
...
func (fake *FakeImage) ReferenceCallCount() int {
	fake.referenceMutex.RLock()
	defer fake.referenceMutex.RUnlock()
	return len(fake.referenceArgsForCall)
}

func (fake *FakeImage) ReferenceReturns(result1 types.ImageReference) {
...
func (fake *FakeImage) ReferenceReturnsOnCall(i int, result1 types.ImageReference) {
	fake.ReferenceStub = nil
...
func (fake *FakeImage) Close() error {
...
func (fake *FakeImage) CloseCallCount() int {
	fake.closeMutex.RLock()
	defer fake.closeMutex.RUnlock()
	return len(fake.closeArgsForCall)
}

func (fake *FakeImage) CloseReturns(result1 error) {
	fake.CloseStub = nil
...
func (fake *FakeImage) CloseReturnsOnCall(i int, result1 error) {
	fake.CloseStub = nil
...
func (fake *FakeImage) Manifest() ([]byte, string, error) {
...
func (fake *FakeImage) ManifestReturns(result1 []byte, result2 string, result3 error) {
...
func (fake *FakeImage) ManifestReturnsOnCall(i int, result1 []byte, result2 string, result3 error) {
	fake.ManifestStub = nil
...
func (fake *FakeImage) SignaturesCallCount() int {
...
func (fake *FakeImage) SignaturesReturnsOnCall(i int, result1 [][]byte, result2 error) {
	fake.SignaturesStub = nil
...
func (fake *FakeImage) ConfigInfo() types.BlobInfo {
...
func (fake *FakeImage) ConfigInfoCallCount() int {
	fake.configInfoMutex.RLock()
	defer fake.configInfoMutex.RUnlock()
	return len(fake.configInfoArgsForCall)
}

func (fake *FakeImage) ConfigInfoReturns(result1 types.BlobInfo) {
...
func (fake *FakeImage) ConfigInfoReturnsOnCall(i int, result1 types.BlobInfo) {
	fake.ConfigInfoStub = nil
...
func (fake *FakeImage) ConfigBlob() ([]byte, error) {
...
func (fake *FakeImage) ConfigBlobCallCount() int {
	fake.configBlobMutex.RLock()
	defer fake.configBlobMutex.RUnlock()
	return len(fake.configBlobArgsForCall)
}

func (fake *FakeImage) ConfigBlobReturns(result1 []byte, result2 error) {
...
func (fake *FakeImage) ConfigBlobReturnsOnCall(i int, result1 []byte, result2 error) {
	fake.ConfigBlobStub = nil
...
func (fake *FakeImage) OCIConfig() (*v1.Image, error) {
...
func (fake *FakeImage) OCIConfigCallCount() int {
	fake.oCIConfigMutex.RLock()
	defer fake.oCIConfigMutex.RUnlock()
	return len(fake.oCIConfigArgsForCall)
}

func (fake *FakeImage) OCIConfigReturns(result1 *v1.Image, result2 error) {
...
func (fake *FakeImage) OCIConfigReturnsOnCall(i int, result1 *v1.Image, result2 error) {
	fake.OCIConfigStub = nil
...
func (fake *FakeImage) LayerInfos() []types.BlobInfo {
...
func (fake *FakeImage) LayerInfosCallCount() int {
	fake.layerInfosMutex.RLock()
	defer fake.layerInfosMutex.RUnlock()
	return len(fake.layerInfosArgsForCall)
}

func (fake *FakeImage) LayerInfosReturns(result1 []types.BlobInfo) {
...
func (fake *FakeImage) LayerInfosReturnsOnCall(i int, result1 []types.BlobInfo) {
	fake.LayerInfosStub = nil
...
func (fake *FakeImage) EmbeddedDockerReferenceConflicts(ref reference.Named) bool {
...
func (fake *FakeImage) EmbeddedDockerReferenceConflictsCallCount() int {
...
func (fake *FakeImage) EmbeddedDockerReferenceConflictsArgsForCall(i int) reference.Named {
	fake.embeddedDockerReferenceConflictsMutex.RLock()
	defer fake.embeddedDockerReferenceConflictsMutex.RUnlock()
	return fake.embeddedDockerReferenceConflictsArgsForCall[i].ref
}

func (fake *FakeImage) EmbeddedDockerReferenceConflictsReturns(result1 bool) {
...
func (fake *FakeImage) EmbeddedDockerReferenceConflictsReturnsOnCall(i int, result1 bool) {
	fake.EmbeddedDockerReferenceConflictsStub = nil
...
func (fake *FakeImage) Inspect() (*types.ImageInspectInfo, error) {
...
func (fake *FakeImage) InspectCallCount() int {
	fake.inspectMutex.RLock()
	defer fake.inspectMutex.RUnlock()
	return len(fake.inspectArgsForCall)
}

func (fake *FakeImage) InspectReturns(result1 *types.ImageInspectInfo, result2 error) {
...
func (fake *FakeImage) InspectReturnsOnCall(i int, result1 *types.ImageInspectInfo, result2 error) {
	fake.InspectStub = nil
...
func (fake *FakeImage) UpdatedImageNeedsLayerDiffIDs(options types.ManifestUpdateOptions) bool {
...
func (fake *FakeImage) UpdatedImageNeedsLayerDiffIDsCallCount() int {
...
func (fake *FakeImage) UpdatedImageNeedsLayerDiffIDsArgsForCall(i int) types.ManifestUpdateOptions {
	fake.updatedImageNeedsLayerDiffIDsMutex.RLock()
	defer fake.updatedImageNeedsLayerDiffIDsMutex.RUnlock()
	return fake.updatedImageNeedsLayerDiffIDsArgsForCall[i].options
}

func (fake *FakeImage) UpdatedImageNeedsLayerDiffIDsReturns(result1 bool) {
...
func (fake *FakeImage) UpdatedImageNeedsLayerDiffIDsReturnsOnCall(i int, result1 bool) {
	fake.UpdatedImageNeedsLayerDiffIDsStub = nil
...
func (fake *FakeImage) UpdatedImage(options types.ManifestUpdateOptions) (types.Image, error) {
...
func (fake *FakeImage) UpdatedImageCallCount() int {
	fake.updatedImageMutex.RLock()
	defer fake.updatedImageMutex.RUnlock()
	return len(fake.updatedImageArgsForCall)
}

func (fake *FakeImage) UpdatedImageArgsForCall(i int) types.ManifestUpdateOptions {
	fake.updatedImageMutex.RLock()
	defer fake.updatedImageMutex.RUnlock()
	return fake.updatedImageArgsForCall[i].options
}

func (fake *FakeImage) UpdatedImageReturns(result1 types.Image, result2 error) {
...
func (fake *FakeImage) UpdatedImageReturnsOnCall(i int, result1 types.Image, result2 error) {
	fake.UpdatedImageStub = nil
...
func (fake *FakeImage) IsMultiImage() bool {
...
func (fake *FakeImage) IsMultiImageReturnsOnCall(i int, result1 bool) {
	fake.IsMultiImageStub = nil
...
var _ types.Image = new(FakeImage)
