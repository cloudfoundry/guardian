...
func (s *StoreMeasurer) MeasureStore(logger lager.Logger) (uint64, error) {
...
func (s *StoreMeasurer) measurePath(path string) (uint64, error) {
...
func (s *StoreMeasurer) parseDuContents(contents string) (uint64, error) {
